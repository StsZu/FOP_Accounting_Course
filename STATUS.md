...
**Стан на 07.09.2026:** курс `0.15.0`, опубліковано 10 модулів із 38, 78 джерел у реєстрі. **Рівні 1, 2 і 3 укомплектовано повністю**, усі три мають рівневі перевірки. Усі автоперевірки проходять. **Людської перевірки не проходив жоден модуль**; ручний прохід у браузері не проводився з версії `0.2.2`. Артефакт — 1527 КБ: до порога 2 МБ лишається приблизно три модулі (`TASK/SCALING_PLAN.md` §8).
