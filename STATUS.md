...
**Стан на 07.09.2026:** курс `0.15.0`, опубліковано 10 модулів із 38, 78 джерел у реєстрі. **Рівні 1, 2 і 3 укомплектовано повністю**, усі три мають рівневі перевірки. Усі автоперевірки проходять. **Людської перевірки не проходив жоден модуль**; ручний прохід у браузері не проводився з версії `0.2.2`. Артефакт — 1527 КБ, ≈161 КБ на модуль; порогу розміру немає — рішення власника від 07.09.2026 (`TASK/SCALING_PLAN.md` §8.2).

**Рівневі квізи.** Рівні 1, 2 і 3 закрито, усі три рівневі перевірки створені й доступні в застосунку (`quizzes/levels/level_01_quiz.json`, `level_02_quiz.json`, `level_03_quiz.json` — по 12 наскрізних питань; людська перевірка не проводилася). Рівні 4–8 рівневих квізів не мають: вони створюються, коли всі модулі рівня доведено до `app_ready`.
...
| 8 | 3 | Банківський рахунок ФОП | AI + бухгалтер | fact_checked | current | quiz_ready | app_ready | 2026-09-07 | Створено за `TASK/LEVEL_03_TECHNICAL_ASSIGNMENT.md`; відкрито рівень 3. Людська перевірка не проведена — три відкриті питання: внесення власних коштів, база доходу при утриманій комісії, дата доходу при еквайрингу. Наступна перевірка джерел — 01.11.2026 |
| 9 | 3 | Класифікація операцій | AI + бухгалтер | fact_checked | current | quiz_ready | app_ready | 2026-09-07 | Центральна практична навичка курсу: класифікація виписки за десятьма типами. Людська перевірка не проведена; повторює три відкриті питання модулів 2 і 8 і не закриває їх. Наступна перевірка джерел — 01.11.2026 |
| 10 | 3 | Готівка, РРО і ПРРО | AI + бухгалтер | fact_checked | current | quiz_ready | app_ready | 2026-09-07 | **Рівень 3 укомплектовано.** Головна знахідка: реєстратори не застосовуються лише платниками ЄП першої групи — пороги за обсягом доходу для інших груп у чинній редакції відсутні. Людська перевірка не проведена — запит на весь рівень у `review/level_03_human_review.md`. Наступна перевірка джерел — 01.11.2026 |
