...
**Стан на 07.09.2026:** курс `0.11.0`, опубліковано 6 модулів із 38, 67 джерел у реєстрі. Усі автоперевірки проходять. **Людської перевірки не проходив жоден модуль**; ручний прохід у браузері не проводився з версії `0.2.2`. Чотири останні коміти не запушено — деталі в `TASK.md`, розділ «Стан на кінець сесії».
